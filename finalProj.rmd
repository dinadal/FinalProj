...
MSE
```{r}
ggplot(df_long, aes(x = models, y = Value, color = models)) +
  geom_line() +
  labs(title = "Comparison of Model Performance - MSE",
       x = "Models",
       y = "MSE") +
  theme_minimal()
```
...
ggplot(df_long, aes(x = models, y = Value, color = models)) +
  geom_line() +
  labs(title = "Comparison of Model Performance - RMSE",
       x = "Models",
       y = "RMSE") +
  theme_minimal()
```
...
ggplot(df_long, aes(x = models, y = Value, color = models)) +
  geom_line() +
  labs(title = "Comparison of Model Performance - MAE",
       x = "Models",
       y = "MAE") +
  theme_minimal()
```
...
GBM_predictions <- predict(GBM_model, newdata = X_test, n.trees = 100)
...
# Plot the actual values and predictions
ggplot(results_long, aes(x = Actual, y = Prediction)) +
